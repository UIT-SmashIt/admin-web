...
export function ScheduleGrid({
  ...
  return (
    <div style={{ flex: 1, display: 'flex', flexDirection: 'column', overflow: 'hidden', background: '#fff' }}>
      ...
      <div style={{ display: 'flex', flexShrink: 0, borderBottom: '1px solid #ebebeb', background: '#fff', zIndex: 10 }}>
        {/* Time column spacer */}
        <div style={{ width: TIME_W, flexShrink: 0, height: HEADER_H }} />
        {/* Day headers */}
        {weekDates.map((date, di) => {
          const isToday = new Date().toDateString() === date.toDateString();
          return (
            <div key={di} style={{
              flex: 1, minWidth: 80, height: HEADER_H,
                    ...
                    return (
                      <div
                        ...
                        style={{
                          ...
                          background: (shiftStaff[0]?.color ?? '#f0f0ee') + '22',
                      ...
                      >
                        <div style={{ fontSize: 10, color: shiftStaff[0]?.color ?? '#666', fontWeight: 600, marginBottom: 3 }}>
                          {fmt(shift.fromTime)} – {fmt(shift.toTime)}
                        </div>
